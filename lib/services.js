...
function Services(program, spinner) {
    ...
    switch (program.compute) {
      case "create":
        compute.createInstance(
          ...
          (error, data) => {
            logger(data, error, program.pretty);
          }
        );
        break;
      case "list":
      ...
      default:
        throw new Error(
          chalk.bgYellow(
            chalk.black("Please select a valid command for Compute")
          )
        );
        break;
    }
  ...
  if (program.storage) {
    ...
    switch (program.storage) {
      ...
      default:
        throw new Error(
          chalk.bgYellow(
            chalk.black("Please select a valid command for Storage")
          )
        );
        break;
    }
  ...
  if (program.database) {
    ...
    switch (program.database) {
      ...
      default:
        throw new Error(
          chalk.bgYellow(
            chalk.black("Please select a valid command for Database")
          )
        );
        break;
    }
  ...
  if (program.iam) {
    ...
    switch (program.iam) {
      ...
      default:
        throw new Error(
          chalk.bgYellow(chalk.black("Please select a valid command for IAM"))
        );
        break;
    }
  }
